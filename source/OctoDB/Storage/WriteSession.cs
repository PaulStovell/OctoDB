...
namespace OctoDB.Storage
{
    public class WriteSession : IWriteSession, IWriteAttachments
    {
        ...
        public WriteSession(IStorageEngine storage, IStatistics statistics, IEncoderRegistry encoder, IAnchor anchor, List<IWriteSessionExtension> extensions, Action disposed)
        {
